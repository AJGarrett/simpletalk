USE [master]
GO
/****** Object:  StoredProcedure [dbo].[sp_automate_restore]    Script Date: 4/18/2017 11:34:20 AM ******/
SET ANSI_NULLS ON
GO
...
AND REPLACE(LEFT(RIGHT(backupFile,19),15),'_','') < @PointInTime --AG
        IF (@DebugLevel = 1
            OR @DebugLevel = 3
           )
            BEGIN
...
BEGIN
PRINT @DebugLevelString + '@lfb = ' + @lfb
PRINT @DebugLevelString + '@ldb = ' + @ldb
PRINT @DebugLevelString + '@PointInTime = ' + @PointInTime
END
